...
<form id="join" action="join_form" method="post" name="formm" style="margin-top: 80px;">
...
제 1 조 (목적) 
이 이용약관(이하 '약관')은 주식회사 HBS(이하 회사라 합니다)와 이용 고객(이하 '회원')간에 회사가 제공하는 서비스의 가입조건 및 이용에 관한 다음의 제반 사항과 기타 기본적인 사항을 구체적으로 규정함을 목적으로 합니다.

제 2 조 (이용약관의 효력 및 변경) 
(1) 이 약관은 HBS 웹사이트(www.HBS.com 이하 'HBS 웹')에서 온라인으로 공시함으로써 효력을 발생하며, 합리적인 사유가 발생할 경우 관련법령에 위배되지 않는 범위 안에서 개정될 수 있습니다. 개정된 약관은 온라인에서 공지함으로써 효력을 발휘하며, 이용자의 권리 또는 의무 등 중요한 규정의 개정은 사전에 공지합니다.
...
제 4 조 (용어의 정의) 
(1) "이용자" 또는”회원”이란 "JSTL"에 접속하여 본 약관에 따라 "JSTL"에 가입하여, 이용 고객의 식별과 이용고객의 서비스 이용을 위하여 이용고객 본인이 직접 선정하고 회사가 부여하는 문자와 숫자 조합인 ‘이용자번호(ID)’와 그에 따라 일치된 이용고객임을 확인하기 위하여 이용고객 본인이 선정한 ‘비밀번호’를 이용하여 "JSTL"이 제공하는 서비스를 받는 자를 말합니다.
...
-- 이하생략
            ...
            <tr>
              <td>
                <input type="checkbox" class="agree">이용약관에 동의합니다.<br><br><br><br>
              </td>
            </tr>
            <tr>
              <td>
...
--이하 생략
            ...
            <tr>
              <td>
                <input type="checkbox" class="agree">개인정보 수집 및 이용에 대한 안내에 동의합니다.
              </td>
            </tr>
          </table>
...
<br><br>
  ...
  <input type="button" value="약관동의" class="btn_join" class="submit"  onclick="go_next()"> 
  <a href="login_form"> <button type = "button"  class="btn_cancel" style="margin:10px;">취 소</button></a>
	</div>
</form>
